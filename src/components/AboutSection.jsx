  ...
  return (
    <section 
      ...
      style={{
        ...
        background: '#0a0a1a',  // Solid background for testing
        minHeight: 'auto',
        width: '100%',
    ...
    >
      <div style={{ 
        ...
        {/* Bottom Banner */}
        <div style={{
          background: 'linear-gradient(135deg, rgba(88, 101, 242, 0.15), rgba(75, 108, 183, 0.08))',
          borderRadius: '20px',
          padding: '40px 20px',
          textAlign: 'center',
          border: '1px solid rgba(88, 101, 242, 0.3)'
          ...
          <p style={{
            ...
            Building tomorrow's enterprises with family values and global vision
          </p>
        </div>
      </div>
    </section>
